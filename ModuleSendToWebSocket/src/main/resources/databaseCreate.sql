...
VALUES ('Машина для стыковой сварки', 'add1', 1, 1),
       ...
       ('Машина для стыковой сварки', 'add6', 2, 1);

insert into moldingStages (id, name, description)
values (0, 'Ожидание детали', 'описание для нулевого этапа'),
       (1, 'Деталь помещается в машину для сварки', 'описание для первого этапа'),
...
VALUES ('Входное напряжение главной цепи', 'В', 0, 0, FALSE, 1, 0),
       ('Входное напряжение главной цепи', 'В', 0, 0, FALSE, 1, 1),
       ...
       ('Вторичное напряжение', 'В', 0, 0, FALSE, 2, 0),
       ...
       ('Усилие сжатия стыка', 'кН', 0, 0, FALSE, 3, 0),
       ...
       ('Время оплавления', 'с', 0, 0, FALSE, 4, 0),
       ('Время оплавления', 'с', 0, 0, FALSE, 4, 1),
       ('Время оплавления', 'с', 4.9, 5.1, TRUE, 4, 2),
       ('Время оплавления', 'с', 4.9, 5.1, TRUE, 4, 3),
       ('Время оплавления', 'с', 0, 0, FALSE, 4, 4),
       ('Время осадки', 'с', 0, 0, FALSE, 5, 0),
       ('Время осадки', 'с', 0, 0, FALSE, 5, 1),
       ('Время осадки', 'с', 0, 0, FALSE, 5, 2),
       ('Время осадки', 'с', 1.9, 2.1, TRUE, 5, 3),
       ('Время осадки', 'с', 1.9, 2.1, TRUE, 5, 4);
